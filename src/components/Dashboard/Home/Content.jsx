  ...
  return (
    <div className="bg-slate-100 lg:py-8 lg:px-8 w-auto overflow-y-auto">
      <p className="mb-20">
        ...
        quaerat minus? Obcaecati assumenda nostrum nisi aspernatur quo eligendi
        non vitae deserunt molestiae perferendis earum magnam, numquam aut
        eveniet itaque autem, architecto voluptatum temporibus nemo quia
        repellendus est. Sed dolores facere quaerat repudiandae consectetur
        nulla, quod accusamus numquam dolore blanditiis. Nihil tenetur ea hic!
        Iusto consectetur dolore quibusdam explicabo culpa, soluta molestiae
        adipisci harum nemo quis, hic blanditiis libero, voluptatibus voluptatem
        fugit omnis fuga a? Reiciendis delectus, corporis nesciunt, iure labore
        odit necessitatibus odio, itaque totam nulla illum deserunt
        perspiciatis.
      </p>
      <p>
